...
import com.example.domains.contracts.repositories.RentalsRepository;
...
class RentalServiceImplTest {
	List<Rental> listado;
	RentalsRepository dao;
	
	@BeforeEach
	void setUp() throws Exception {
		listado = new ArrayList<Rental>();
		listado.add(new Rental(1, new Date(116 , 2, 4)));
		listado.add(new Actor(2, "dos", "ados"));
		dao = mock(RentalsRepository.class);
	}
